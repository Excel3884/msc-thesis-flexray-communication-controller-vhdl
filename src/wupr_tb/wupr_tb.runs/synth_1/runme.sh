...
HD_PWD='/home/angel/wupr_tb/wupr_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wupr_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wupr_main.tcl
