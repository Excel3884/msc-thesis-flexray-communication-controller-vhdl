...
HD_PWD='/home/angel/cs_tb/cs_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microtick_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microtick_counter.tcl
