...
HD_PWD='/home/angel/mil_tb/mil_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mil_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mil_main.tcl
