...
HD_PWD='/home/angel/wupg_tb/wupg_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wupg_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wupg_main.tcl
